...
4. **人物追蹤**：追蹤畫面中的人物，標註 ID 與警戒距離

<div align="center">
    <img src="assets/results_38.jpg" width=80%>
</div>
...
### 整體架構
<div align="center">
    <img src="assets/C4_model.png" width=50%>
</div>
...
- `/detect/` - 人體識別並標註結果
- `/detect/inside_outside_alert/` - 判斷人體是否在警戒區內
- `/detect/distance_to_alert_zone/` - 計算人體距離警戒區的距離
- `/tracking/` - 標註人物ID與警戒距離
